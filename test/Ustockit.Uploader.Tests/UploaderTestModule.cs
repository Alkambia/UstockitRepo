...
namespace Ustockit.Uploader.Tests
{
    ...
    public class UploaderTestModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(UploaderTestModule).GetAssembly());
        }
        ...
        private void SetupInMemoryDb()
        {
            ...
            IocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<UploaderDbContext>>()
